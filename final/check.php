...
<?php if (isset($_POST['submit'])) {
    ...
    for ($i = 0; $i < $len; $i++) {
        ...
        $sql1 = "INSERT INTO order_details (order_id,product_id,product_price,product_qty,userid,`date`,`status`)VALUES ($order_id,'$id','$price','$quantity','$userid','$time','$status')";
            ...
            <?php if (mysqli_num_rows($result) > 0) { ?>
                ...
                ?>
                        <tr class="row">
                            ...
                            <td class="row"><a href="check.php?id=<?php echo $row['product_id']; ?>&userid=<?php echo $row['userid']; ?>&action=remove"><i class="fa fa-times" style="color:red;"></i></a></td>
