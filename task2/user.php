...
<body>
    ...
    // ARRAY OF PRODUCTS
    $products = array(
        array('id' => 'Product101', 'price' => '$150', 'img' =>
        'images/football.png'),
        array('id' => 'Product102', 'price' => '$120', 'img' =>
        'images/tennis.png'),
        array('id' => 'Product103', 'price' => '$90', 'img' =>
        'images/basketball.png'),
        array('id' => 'Product104', 'price' => '$110', 'img' =>
        'images/table-tennis.png'),
        array('id' => 'Product105', 'price' => '$80', 'img' =>
        'images/soccer.png')
    );

    ?>
    <!-- <?php display1($selected_product);  ?> -->
    <div>
            ...
            <table>
                ...
                <tr>
                    ...
                    foreach ($selected_product as $key =>
                        ...
                        <td>
                            <form action="" method="GET"><input type="text" name="tex" value="<?php echo $value['quantity']; ?>">
                                <input type="hidden" name="id" value="<?php echo $value['id']; ?>">
                                <input type="submit" name="action" value="UPDATE">
                            </form>
                        </td>
                        <td>
                            <form action="" method="GET"><a href="user.php?id=<?php echo
        ...
        <form action="" method="GET">
            <?php foreach ($products as $key => $value) : ?>
                <div id="product-101" class="product">
                    ...
                    <a class="add-to-cart" href="user.php?id=<?php echo $value['id']; ?>&price=<?php
