...
<?php echo '<a href="logout.php" id="remove">LOGOUT</a>'; ?>
<div id="main">
    <div id="products">
        <form action="" method="GET">
            <?php foreach ($products as $key => $value) : ?>
                <div id="product-101" class="product">
                    ...
                    <a class="add-to-cart" href="index.php?id=<?php echo $value['id']; ?>&price=<?php
    ...
    <div>
        ...
        ?>
                <table>
                    ...
                    <tr>
                        ...
                        foreach ($selected_product as $key =>
                            ...
                            <td>
                                <form action="" method="GET"><a href="index.php?id=<?php echo
                ...
                <?php echo '<form action="checkout.php" method="POST">
